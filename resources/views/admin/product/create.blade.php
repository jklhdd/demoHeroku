...
<div class="col-lg-6 col-md-6 col-sm-6">
    ...
    <div id="message"></div>
    <form class="contact-form php-mail-form" role="form" action="{{url('admin/tables/product/store')}}" method="POST">
        @csrf
        <div class="form-group @if($errors->has('product_name'))has-error @endif">
            <input type="text" name="product_name" class="form-control " id="product_name" 
            placeholder="Product Name" minlength="4" value="{{old('product_name')}}" required>
        ...
        <div class="form-group @if($errors->has('product_desc'))has-error @endif">
            ...
            placeholder="Product Description" minlength="4" value="{{old('product_desc')}}" required>
            <div class="validate"></div>
        </div>
